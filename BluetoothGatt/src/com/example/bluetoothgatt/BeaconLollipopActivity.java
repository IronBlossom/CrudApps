...
public class BeaconLollipopActivity extends Activity {
    ...
    private void startScan() {
        ...
        ScanFilter beaconFilter = new ScanFilter.Builder()
                .setServiceUuid(TemperatureBeacon.TRANSFER_SERVICE)
                .build();
    ...
    private ScanCallback mScanCallback = new ScanCallback() {
        ...
        private void processResult(ScanResult result) {
            Log.i(TAG, "New LE Device: " + result.getDevice().getName() + " @ " + result.getRssi()+" @ "+(result.getDevice().getUuids()!=null?result.getDevice().getUuids()[0]:null));
    ...
    private static class BeaconAdapter extends ArrayAdapter<TemperatureBeacon> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            tempView.setText(beacon.getChar());
